...
QT_MOC_LITERAL(5, 10), // "signalForm"
QT_MOC_LITERAL(16, 0), // ""
QT_MOC_LITERAL(17, 21) // "on_pushButton_clicked"

    },
    "Form\0signalForm\0\0on_pushButton_clicked"
};
...
void Form::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signalForm((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Form::signalForm)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Form::signalForm(QString _t1)
{
